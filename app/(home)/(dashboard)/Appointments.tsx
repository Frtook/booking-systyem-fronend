...
const Appointment = ({ appoinment }: { appoinment?: IAppointment }) => {
  ...
  return (
    <div className="hover:bg-[#FFEBEB] transition-colors duration-300 rounded p-2 md:p-4">
      <div className="flex gap-10">
        <div className="flex flex-col self-center items-center px-3 py-2 md:px-6 md:py-4 rounded-xl shadow-md bg-white">
          <p>{day}</p>
